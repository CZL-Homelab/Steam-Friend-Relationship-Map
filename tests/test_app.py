...
from steam_friend_relationship_map.models import ExportResponse, GraphEdge, GraphNode, GraphResponse
...
def test_graph_endpoint_uses_repo() -> None:
    app = create_app(settings=Settings(), repo=FakeRepo(), steam=SteamClient("key"))  # type: ignore[arg-type]
